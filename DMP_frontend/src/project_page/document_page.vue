...
<div>
  <div>
    <el-form inline>
      <el-form-item label="文件名:">
        <el-input size="small" placeholder="请输入文件名"></el-input>
      </el-form-item>
      <el-form-item label="上传人:">
        <el-input size="small" placeholder="请输入上传人"></el-input>
      </el-form-item>
      <el-form-item>
        ...
        <el-table>
          ...
          <el-table-column label="操作">
            <div slot-scope="scope">
              ...
              <el-button v-if="$cookies.get('user_type')==='管理员'" size="small">删除</el-button>
            </div>
          </el-table-column>
        </el-table>
      </div>
  ...
  <div>
    <el-dialog :visible="dialogVisible">
      ...
      <div>
        <Upload :pid="sessionStorage.getItem('pid')" :creator="$cookies.get('username')"></Upload>
      </div>
    </el-dialog>
  </div>
</div>
